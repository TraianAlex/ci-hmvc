...
// ------------CUSTOM METHODS-----------------------------------------------------
    ...
    //bring validation rules from a config file by subname of an array
    //and set them ($this->validate) before validation
    public function set_validation($array){
        $this->config->load('form_validation');
        $this->validate = $this->config->item($array);
